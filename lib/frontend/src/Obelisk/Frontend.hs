...
extendedHead :: forall route js t m. ObeliskWidget js t route m => Frontend route -> RoutedT t route m ()
extendedHead frontend = do
  ...
  baseTag >> injectExecutableConfigs >> _frontend_head frontend
