### COPIED FROM
### https://github.com/NixOS/nixpkgs/blob/1d36ad6d16dbf1d3937f899a087a4360332eb141/nixos/modules/security/acme.nix
###
### to support new plugins in simp_le for ACMEv2 support.
### Changed lines are marked with a comment: ### CHANGED
    ...
    options = {
      ...
      plugins = mkOption {
        type = types.listOf (types.enum [
          ...
          "fullchain.pem" "full.pem" "key.der" "key.pem" "account_key.json" "account_reg.json" ### CHANGED
        ]);
        default = [ "fullchain.pem" "full.pem" "key.pem" "account_key.json" "account_reg.json" ]; ### CHANGED
        description = ''
